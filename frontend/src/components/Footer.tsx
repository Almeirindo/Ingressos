      ...
      <div className="max-w-6xl mx-auto px-4 py-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-white font-bold text-lg">IngressosDaBanda</h3>
            </div>
            <p className="text-gray-300 text-sm">
              O melhor lugar para comprar ingressos para os maiores eventos da cidade. Simples, rápido e seguro.
            </p>
            <div className="flex gap-4 mt-4">
              <a
                href="https://instagram.com/ingressosdabanda "
                target="_blank"
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <a href="mailto:ingressosdabanda@gmail.com" className="text-gray-300 hover:text-white transition-colors duration-200">
              ...
              <li className="flex items-center">
                ...
                <a href="tel:+244949928157" className="text-gray-300 hover:text-white transition-colors duration-200">
                  +244 949 928 157
                </a>
              </li>
        ...
        <div className="border-t border-white/10 mt-8 pt-4 text-center">
          <p className="text-gray-400 text-sm">
            © 2024 IngressosDaBanda. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
